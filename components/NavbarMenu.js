...
const useStyles = makeStyles((theme) => ({
  ...
  ,
  logo:{display:'block',width:'70px',height:'40px',objectFit:'cover',cursor:'pointer',
...
export default function DenseAppBar({valuee}) {
  const line = ['','diem-song-ao','quancaphe','diem-an-uong','diem-an-vat','ngu-nghi','dac-san-da-lat']
  ...
  return (
    <div className={classes.root}>
      <AppBar position="static" style={{boxShadow:'none',background:'white',color:'black'}}>
        <Toolbar variant="dense" style={{display:'flex',justifyContent:'space-between'}}>
        
            <img onClick={()=>{handleChange('e',0)}} className={classes.logo} src="https://bazantravel.com/cdn/medias/uploads/19/19202-qt-600x600.jpg" alt="adsad"></img>
      ...
      <div style={valuee==0 ? {display:'none'}:{marginLeft:'25px',marginTop:'24px'}}>
      <BreadCum handleChangeBreaCum={handleChangeBreaCum} val={valuee}></BreadCum>
