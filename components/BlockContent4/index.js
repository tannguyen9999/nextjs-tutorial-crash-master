...
import Layzyy from "../Lazyy/index";
const BlockContent = () => {
  ...
  return (
    <div className={styless.main}>
      ...
      <div className={styless.titleSection}>
        Tulu Tula Coffee – Không gian sống ảo hòa mình với thiên nhiên Đà Lạt
      </div>
      ...
      <div className={styless.structure}>
        ...
        <a
          href="#gioi-thieu-tutu-dalat"
          style={{ color: "white", textDecoration: "none" }}
        >
          <div className={styless.structureItem}>
            {" "}
            Giới thiệu về Tulu Tula Đà Lạt
          </div>
        </a>
        <a
          href="#gia-ve-tutu"
      ...
      <div className={styless.item}>
        Tulu Tula là khu tổ hợp coffee, check-in & ăn uống với nhiều concept
        được đầu tư chỉnh chu. Tulu Tula giúp chúng ta hòa mình với thiên nhiên
        đầy quyến rũ. Là địa điểm mới ra thu hút được nhiều quan tâm của giới
        trẻ yêu sống ảo. Hãy cùng DALATWEGO.COM khám phá ngay độ hot của địa
        điểm này bạn nhé!
      </div>
      <div
      ...
      <div id="gioi-thieu-tutu-dalat" className={styless.titleSection2}>
        Giới thiệu về Tulu Tula Đà Lạt
      </div>
      <div className={styless.item}>
        Chìm đắm trong những không gian quán cà phê xinh đẹp xịn sò như không
        gian cổ tích thì Đà Lạt không kể hết. Nhưng không gian cổ tích xịn sò
        với tạo hình từ gỗ, và ngập tràn trong bối cảnh của rừng cây lẫn núi đồi
        thì không thể bỏ qua Tulu Tula Coffee.
      </div>
      <div
        onClick={(e) => handleZoom(e)}
        style={{
      ...
      <div className={styless.item}>
        Tulu Tula không gian cà phê xanh của miền cổ tích mới toanh mà chúng ta
        không thể nào bỏ qua. Quán có không gian check-in giữa quả đồi rộng
        6000m2 cùng khu vườn cổ tích độc đáo với nhiều góc chụp thật thần thánh.
      </div>
      <div
        style={{
          display: "block",
        ...
        onClick={(e) => handleZoom(e)}
      >
        <Layzyy src="https://dalatwego.com/wp-content/uploads/2021/04/caphe_tulu_tula_da_lat_17_1608039526.jpeg"></Layzyy>
      </div>
      ...
      <div id="gia-ve-tutu" className={styless.titleSection2}>
        Giá vé Tulu Tula là bao nhiêu?
      </div>
      <Layzyy src="https://dalatwego.com/wp-content/uploads/2021/04/A%CC%89nh-chu%CC%A3p-Ma%CC%80n-hi%CC%80nh-2021-04-18-lu%CC%81c-23.43.32-1024x196.png"></Layzyy>
      <i className={styless.note}>
        Các bạn lưu ý: Giá vé đã bao gồm 1 nước uống. Dịch vụ thuê trang phục
        chụp ảnh ngoại cảnh không giới hạn thời gian thuê nhé!
      </i>
      <div id="chi-duong-tutu" className={styless.titleSection2}>
        Chỉ đường đi Tulu Tula Coffee
      </div>
      <div className={styless.item}>
        – Vị trí: Quốc lộ 20, xã Xuân Trường Đà Lạt (trên tuyến đường đi đồi chè
        cầu đất bạn sẽ thấy cây xăng 27. Tulu Tula cách cây xăng 100m)
        <br />– Chỉ đường trên Google Maps:
        https://g.page/khudulichtulutula?share
        <br />– Hotline hỗ trợ: 0935.260.792
        <br />– Fanpage chính thức: https://www.facebook.com/tulutula.vn/
        <br />– Giờ mở cửa : 6h-18h mỗi ngày.
      </div>
      <div id="hinh-anh-dep" className={styless.titleSection2}>
        Hình ảnh đẹp từ du khách
      </div>
      <div
        onClick={(e) => handleZoom(e)}
        style={{
