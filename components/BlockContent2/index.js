...
const BlockContent2 = ()=>{
    return(
        <div>
            ...
            <Head>
            <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0" nonce="L5tyOzeG"></script>
            </Head>
            <Title title={'Ket noi'}></Title>
            <div id="fb-root"></div>

<div class="fb-page" data-href="https://www.facebook.com/muaduaxiemgiasi/" data-tabs="timeline" data-width="" data-height="70" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/muaduaxiemgiasi/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/muaduaxiemgiasi/">ALo Dừa</a></blockquote></div>
        ...
        style={{
                ...
                <div style={{color:'white'}} className={styless.date}>{esle4[0].date}</div>
                </div>
